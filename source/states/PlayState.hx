...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Superbuns!.', 0.2], //From 0% to 19%
		['Just use botplay at this point bro', 0.4], //From 20% to 39%
		['Appaling!', 0.5], //From 40% to 49%
		['Not Good', 0.6], //From 50% to 59%
		['Son', 0.69], //From 60% to 68%
		['Grow Up T:<', 0.7], //69%
		['Ok...', 0.8], //From 70% to 79%
		['Nice!', 0.9], //From 80% to 89%
		['Sugoi!!', 1], //From 90% to 99%
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("Huninn-Regular.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("comicbd.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		scoreTxt.scrollFactor.set();
		scoreTxt.borderSize = 1.25;
		scoreTxt.visible = !ClientPrefs.data.hideHud;
		uiGroup.add(scoreTxt);

		botplayTxt = new FlxText(400, healthBar.y - 90, FlxG.width - 800, Language.getPhrase("Showcase Mode").toUpperCase(), 32);
		botplayTxt.setFormat(Paths.font("kyouka.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
inline private function createCountdownSprite(image:String, antialias:Bool):FlxSprite {
	...
	public dynamic function updateScoreText()
	{
		...
		else tempScore = Language.getPhrase('score_text_instakill', 'Score: {1} - INSTAKILL MODE - Accuracy: {2}', [songScore, str]);
